...
describe('Sitemapper Additional Coverage Tests', function () {
    ...
    describe('Crawl edge cases', function () {
        it('should handle empty urlsets correctly', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const result = yield sitemapper.crawl('https://example.com/sitemap.xml');
        ...
        it('should correctly filter URLs with lastmod', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                lastmodMapper.parse = () => __awaiter(this, void 0, void 0, function* () {
                    return {
                        error: null,
                        data: {
                            urlset: {
                ...
                const result = yield lastmodMapper.crawl('https://example.com/sitemap.xml');
                // Debug the result
        ...
        it('should filter old pages by lastmod timestamp', function () {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        it('should handle sitemapindex with a single sitemap (non-array)', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let parseCounter = 0;
                sitemapper.parse = (url) => __awaiter(this, void 0, void 0, function* () {
                    parseCounter++;
                    if (parseCounter === 1) {
                ...
                const result = yield sitemapper.crawl('https://example.com/sitemapindex.xml');
        ...
        it('should handle urlset with a single URL (non-array)', function () {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        it('should handle sitemapindex with both single and array of sitemaps', function () {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        it('should handle successful HTTP response with an error', function () {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        it('should handle fields option with various types of data', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const result = yield fieldsMapper.crawl('https://example.com/sitemap.xml');
                result.should.have.property('sites').which.is.an.Array();
                result.sites.length.should.equal(2);
        ...
        it('should handle special fields like image and video', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                mediaMapper.parse = () => __awaiter(this, void 0, void 0, function* () {
                    return {
                        error: null,
                        data: {
                            urlset: {
                ...
                const result = yield mediaMapper.crawl('https://example.com/media-sitemap.xml');
        ...
        it('should handle gzipped sitemaps correctly', function () {
            return __awaiter(this, void 0, void 0, function* () {
                // Mock the decompressResponseBody method
                const originalDecompress = sitemapper.decompressResponseBody;
                // Create a mock implementation
                sitemapper.decompressResponseBody = () => __awaiter(this, void 0, void 0, function* () {
        ...
        <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
          <url>
            <loc>https://example.com/gzipped-page</loc>
                ...
                const result = yield sitemapper.crawl('https://example.com/sitemap.xml.gz');
                result.should.have.property('sites').which.is.an.Array();
                result.sites.length.should.equal(1);
        ...
        it('should handle missing data object in parse response', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    throw new Error(`crawl() threw an error when data is undefined: ${error.message}`);
                }
                // Restore original method
                sitemapper.parse = originalParse;
            });
        });
        it('should handle missing urlset and sitemapindex in data', function () {
            return __awaiter(this, void 0, void 0, function* () {
    ...
    describe('Debug logging', function () {
        it('should log debug messages when debug is enabled', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    yield debugSitemapper.fetch('https://example.com/fake-url');
        ...
        it('should log errors when debug is enabled', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                debugSitemapper.crawl = () => __awaiter(this, void 0, void 0, function* () {
                    throw new Error('Test error');
                });
                try {
                    yield debugSitemapper.fetch('https://example.com/sitemap.xml');
        ...
        it('should log retry attempt messages when debug is enabled', function () {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    yield debugSitemapper.crawl('https://example.com/sitemap.xml');
        ...
        it('should log debug message when finding a urlset', function () {
            return __awaiter(this, void 0, void 0, function* () {
                // Create a sitemapper with debug enabled
                const debugSitemapper = new Sitemapper({
                    debug: true,
